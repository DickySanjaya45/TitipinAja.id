      ...
      body: Stack(
        children: [
          ...
          Positioned(
            top: -100,
            left: -50,
            child: _buildBlurCircle(300, primaryColor.withOpacity(0.4)),
          ),
          Positioned(
            top: 100,
            right: -80,
            child: _buildBlurCircle(250, const Color(0xFF00C897).withOpacity(0.3)),
          ),
          Positioned(
            bottom: -50,
            left: 20,
            child: _buildBlurCircle(200, Colors.orangeAccent.withOpacity(0.2)),
          ),
            ...
            child: SingleChildScrollView(
              ...
              child: ClipRRect(
                ...
                child: BackdropFilter(
                  filter: ImageFilter.blur(sigmaX: 10, sigmaY: 10), // EFEK KACA
                  child: Container(
                    padding: const EdgeInsets.all(32),
                    decoration: BoxDecoration(
                      color: Colors.white.withOpacity(0.7), // Putih transparan
                      borderRadius: BorderRadius.circular(30),
